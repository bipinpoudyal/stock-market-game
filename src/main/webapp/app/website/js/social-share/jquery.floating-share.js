...
;(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var $template = $("<div>", {id: "floatingShare", class:"styleSwitcher", style:"right:0px;"});
            ...
            $icon.appendTo($a);
            $a.appendTo($template);
            $h1.appendTo($template);
            $script.appendTo($template);

            var $ul = $("<ul>", {class: "switcher"});
    ...
    var networks = {
        ...
        "twitter": { className: "tivitir", url:"https://twitter.com/share?url={url}&text={title}{description}&hashtags=misys,stockmarketleague" },
